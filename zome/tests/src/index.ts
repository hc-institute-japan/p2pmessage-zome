...
orchestrator.registerScenario("p2pmessage", async (s, t) => {
  ...
  t.deepEqual(
    send_alice_2[0].payload.Text.payload,
  ...
  t.deepEqual(
    send_alice_3[0].payload.Text.payload,
  ...
  const message_5_as_reply = {
    receiver: agent_pubkey_alice,
    payload: {
      Text: { payload: "Sure! I would love to go out for coffee with you!" },
    },
  ...
  t.deepEqual(
    reply_bobby[0].payload.Text.payload,
  ...
  t.deepEqual(
    send_carly_2[0].payload.Text.payload,
    "I have an extra ticket to a movie later. Would you want to come with me?"
  );
  ...
  t.deepEqual(
    send_bobby_3[0].payload.Text.payload,
    "Hey, Carly. I'm sorry but I already made plans. maybe some other time?"
  );
  ...
  t.deepEqual(
    send_alice_4[0].payload.Text.payload,
